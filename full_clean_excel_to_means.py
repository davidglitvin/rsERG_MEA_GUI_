...
def process_excel(file_path, output_path, blocks=6, channels_per_eye=8):
    try:
...
def on_run_button_click(b):
    with output:
        ...
        process_excel(input_path, output_path, blocks, channels_per_eye)
...
display(
    widgets.VBox([
        file_picker,
        output_picker,
        widgets.HBox([blocks_widget, channels_per_eye_widget]),
        run_button,
        output
    ])
)
